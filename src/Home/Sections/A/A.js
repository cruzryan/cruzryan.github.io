...
function A(){
    return (<div className="A">
        ...
        <ul>
            ...
            <li>1st place Best Software Award 2019 <span className="note">(Mexico)</span></li>
            <li>1st place Best Software Award 2018 <span className="note">(Mexico)</span></li>
            <li>3rd prize MakeX World Championship 2019 <span className="note">(China)</span></li>
            <li>President's Education Award <span className="note">(USA)</span></li>
